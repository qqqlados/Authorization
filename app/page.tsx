      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8">
        <section className="pt-32 pb-16">
          ...
          >
            ...
            >
              Discover, plan, and organize your dream destinations with our
              interactive travel planner. Create personalized itineraries and
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Interactive map to help you visualize and plan your journey.
...
const features = [
  {
    ...
    description:
      "Visualize your journey with interactive maps and easily plan your routes between destinations.",
    icon: CompassIcon,
  },
  {
    title: "Smart Planning",
    description:
      "Get intelligent suggestions for attractions, restaurants, and activities based on your preferences.",
    icon: MapIcon,
  },
  {
    title: "Weather Insights",
    description:
      "Stay prepared with accurate weather forecasts for all your planned destinations.",
    icon: CloudSunIcon,
  },
];
