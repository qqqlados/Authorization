          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Create and customize your perfect journey
              </p>
            </div>
                ...
                <div className="space-y-2">
                  {selectedLocations.length === 0 ? (
                    <p className="text-muted-foreground text-sm">
                      No places selected yet. Click on the map to add
                      destinations to your trip.
                    </p>
                  ) : (
                        ...
                        {location.comments && location.comments.length > 0 && (
                          <div className="mt-2 space-y-1">
                            {location.comments.map((comment, i) => (
                              <p
                                key={i}
                                className="text-sm text-muted-foreground pl-3 border-l-2"
                              >
                                {comment}
                              </p>
                            ))}
