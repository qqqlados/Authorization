...
export default function ActiveTrips() {
  ...
  const handleAddComment = (locationId: number) => {
    ...
    const updatedSelectedTrip = updatedTrips.find(
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                View and manage your ongoing journeys
              </p>
            </div>
            ...
            <div className="lg:col-span-2">
              {selectedTrip ? (
                <div className="space-y-4">
                  ...
                  <div className="bg-card rounded-lg border p-4">
                    ...
                    {selectedTrip.locations.map((location) => (
                      <div
                        key={location.id}
                        className="mb-4 p-4 bg-background rounded-lg border"
                      >
                        ...
                        {showCommentInput &&
                          selectedLocation?.id === location.id && (
                            <div className="mt-2 flex gap-2">
                              ...
                              <Button
                                size="sm"
                                onClick={() => handleAddComment(location.id)}
                              >
                                Add
                              </Button>
                            </div>
                ...
                <div className="bg-card rounded-lg border p-8 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Choose a trip from the list to view its details and
                    locations
                  </p>
                </div>
              )}
